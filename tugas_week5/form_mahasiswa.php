...
<body>
    <div class="container">
            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <select id="matkul" name="matkul" class="custom-select">
                        ...
                        <option value="statistik">Basis Data</option>
                    </select>
                </div>
            </div>
            <div class="form-group row">
        ...
        $mahasiswa = new nilaiMahasiswa($nama, $nim, $matkul, $nilai);

        echo "Nama: " . $mahasiswa->nama . "<br>";
        echo "NIM: " . $mahasiswa->nim . "<br>";
        echo "Mata Kuliah: " . $mahasiswa->matkul . "<br>";
        echo "Nilai: " . $mahasiswa->nilai . "<br>";
        echo "Hasil Ujian: " . $mahasiswa->hasilNilai() . "<br>";
        echo "Grade " . $mahasiswa->statusGrade() . "<br>";
